...
//if (check == true) {
  ...
  //      swal({
  //          title: "Welcome!",
  //          text: "It seems you are on a mobile device. Some parts of this website will not load correctly.,
//            icon: "info",
//            button: "Okay"
//
...
if (mobile) {
    alert("You seem to be on mobile device. Please access this website on a desktop.");
} else {
}
